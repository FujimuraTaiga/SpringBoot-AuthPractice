...
* The following dependencies are not known to work with Spring Native: 'Spring Session, Spring Boot DevTools, Spring
...
```
$ docker run --rm -p 8080:8080 JavaAuthorizationPractice:0.0.1-SNAPSHOT
```
...
```
$ target/JavaAuthorizationPractice
```
